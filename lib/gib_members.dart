...
class _MembersState extends State<Members> {
  ...
  Future<void> getData(String districts, String chapters) async {
    ...
    try {
      final url = Uri.parse('http://localhost/GIB/lib/GIBAPI/gib_members.php?district=$districts&chapter=$chapters&id=${widget.userId}');
                ...
                Expanded(
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, i) {
                      String imageUrl =
                          'http://localhost/GIB/lib/GIBAPI/${data[i]['profile_image']}';
