...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
   $table = isset($_GET['table']) ? $_GET['table'] : "";
    if ($table == "honor_slip") {
        ...
        $offerlist = "SELECT * FROM honoring_slip WHERE Tomobile='$mobile' OR mobile='$mobile'";
   ...
   $business_name = mysqli_real_escape_string($conn, $data->business_name);
   $business_mobile = mysqli_real_escape_string($conn, $data->business_mobile);
